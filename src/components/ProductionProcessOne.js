  ...
  return (
      ...
      <ProductionContainerStep>
        ...
        <ProductionContainerStepTitle>
          <h2 style={{ margin: "auto", fontSize:21}}> 1. Design & Quotation</h2>
        </ProductionContainerStepTitle>
        <ProductionContainerStepDesc>
          <p style={{ marginLeft: 40, marginRight: 35, fontSize: 18 }}>After establishing garment design, sizing, material, and other essential details, we will provide estimated production quotation.</p>
        </ProductionContainerStepDesc>
      </ProductionContainerStep>
...
export default ProductionProcessOne